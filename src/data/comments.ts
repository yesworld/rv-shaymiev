export default [
  {
    ...
    position: 'Депутат Госдумы РФ, исполнительный директор Республиканского фонда возрождения памятников истории и культуры РТ Т. П. Ларионова',
    ...
    src: '/images/avatars/13 талия2.jpg',
  }, { // 14
    name: 'А. Ф. Султеев',
    text: '\tУважаемый Минтимер Шарипович! \n' +
