export default [
  {
    ...
    text: '\tГлубокоуважаемый Минтимер Шарипович!\n'
        + '\tОт всего сердца поздравляем Вас с замечательной юбилейной датой – 85-летием!\n'
        ...
        + '\tВозглавив регион в сложное для страны время, Вы мудро и смело повели Татарстан к стремительному развитию. Всей своей энергией, всеми знаниями, всем опытом Вы всегда щедро делитесь и ведете за собой к самым масштабным целям. Работать в Вашей команде – это всегда быстрое развитие и большая школа.\n'
        ...
        + '\tВо многом благодаря Вашим усилиям в Татарстане в дружбе и согласии живут и работают люди самых разных конфессий и национальностей, а к татарской нации, языку, традициям и истории в мировом сообществе относятся с большим уважением!\n'
