export default [
  {
    ...
    text: '\tУважаемый Минтимер Шарипович!\n'
        ...
        + '\tУмение строить команду и заряжать ее энергией на продуктивную работу позволило Вам воспитать плеяду эффективных управленцев федерального уровня и обеспечить преемственность власти в республике. Татарстан сегодня благодаря Вашим усилиям – это не только экономически развитый регион, но и кузница кадров.\n'
        ...
        + '\tМира и добра Вам и Вашим близким! С уважением, от имени Группы компаний ТАИФ.',
